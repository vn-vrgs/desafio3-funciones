...
Este desafío tiene como objetivo aprender el dominio de las funciones en JavaScript, la manipulación del DOM y el manejo de eventos mediante una serie de ejercicios prácticos.
...
Proyecto educativo de sitio web estático multi-página que reúne cinco ejercicios prácticos sobre el dominio de funciones en JavaScript, manipulación del DOM y 
manejo de eventos.
No requiere instalación ni servidor: se ejecuta directamente en el navegador invocando a la pagina principal.

---

## Objetivos de aprendizaje

Despues de finalizar este desafío, seremos capaz en:
...
---
## Autor
Este proyecto se realizò con fines educativo, implementado por Ivan Vargas,
bajo la supervisiòn de Desafio Latam.
Latam Bootcamp Desarrollo FullStack · 2026
